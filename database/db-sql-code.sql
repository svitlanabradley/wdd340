...
-- Create relationship between 'classification' and 'inventory' tabels
...
-- Create relationship between 'inventory' and 'review' tabels
...
-- Create relationship between 'account' and 'review' tabels
ALTER TABLE IF EXISTS public.review
